...
//No son necesarios ya que están en el mismo paquete
//import claseAlumnos;
//import arraylistAlumno;
...
public class JFarraylist extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFarraylist frame = new JFarraylist();
	...
	public JFarraylist() {
		...
		btnEliminarFinal = new JButton("Elimnar final");
		btnEliminarFinal.setBounds(450, 100, 155, 23);
		btnEliminarFinal.addActionListener(this);
		contentPane.add(btnEliminarFinal);
		
		btnEliminarTodo = new JButton("Elimnar todo");
		btnEliminarTodo.setBounds(450, 125, 155, 23);
		btnEliminarTodo.addActionListener(this);
		contentPane.add(btnEliminarTodo);
		
		btnTamaño = new JButton("Tamaño");
		btnTamaño.setBounds(450, 150, 155, 23);
		btnTamaño.addActionListener(this);
		contentPane.add(btnTamaño);
		
		btnBuscar = new JButton("Buscar");
		btnBuscar.setBounds(450, 175, 155, 23);
		...
		txtIndice.setBounds(520, 211, 80, 22);
		...
		lblIndice.setBounds(470, 213, 56, 16);
	...
	//  Declaración global
	arraylistAlumno aa = new arraylistAlumno();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == btnTamaño){
			actionPerformedBtnTamaño(arg0);
		}
	...
	protected void actionPerformedBtnAdicionar(ActionEvent arg0) {
		...
		int nota1 = leerNota1();
		int nota2 = leerNota2();
		claseAlumnos nuevo = new claseAlumnos(codigo, nota1, nota2, nombre);
		aa.adicionar(nuevo);
		listar();
		limpieza();
	}
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("nombre del ultimo aprobado : "+aa.nombreUltimoAprobado());
		imprimir("nombre del primer desaprobado : "+aa.nombrePrimerDesaprobado());
	...
	protected void actionPerformedBtnTamaño(ActionEvent arg0) {
		txtS.setText("");
		imprimir("El tamaño del arraylist es "+aa.tamaño());
	}
	...
	protected void actionPerformedBtnBuscar(ActionEvent arg0) {
		...
		txtS.setText("");
		imprimir("Direccion de memoria: "+aa.obtener(indice));
	}
